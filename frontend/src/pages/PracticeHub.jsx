...
export default function PracticeHub() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-[#2e3748] flex items-center justify-center">
      <div className="w-12 h-12 border-4 border-white/20 border-t-blue-600 rounded-full animate-spin" />
    </div>
  );
    ...
    <div className="min-h-screen bg-[#2e3748] p-8 md:p-24 font-sans">
      <div className="max-w-5xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-white tracking-tighter">Practice Hub</h1>
          <p className="text-slate-400 font-medium max-w-lg mx-auto">Select a topic to test your knowledge with interactive challenges and coding tasks.</p>
        </div>
          ...
          {topics.map(topic => (
            ...
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-white/5 text-slate-400 rounded-2xl flex items-center justify-center transition-colors group-hover:bg-blue-600 group-hover:text-white">
                   <BookOpen size={32} />
                </div>
                <div>
