      ...
      <div className="max-w-5xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-[10px] font-black uppercase tracking-widest border border-blue-100">
            <Sparkles size={12} /> Training Center
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {topics.map(topic => (
            <Link 
              ...
              className="group bg-white border border-slate-200 rounded-[2.5rem] p-8 flex items-center justify-between hover:border-blue-500 hover:shadow-2xl hover:shadow-blue-100/50 transition-all"
            >
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 bg-slate-50 text-slate-400 rounded-2xl flex items-center justify-center transition-colors group-hover:bg-blue-50 group-hover:text-blue-600">
                   <BookOpen size={32} />
                </div>
                <div>
              ...
              <div className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-blue-600 group-hover:text-white transition-all -translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100">
