        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
          {topics.map((course) => {
            ...
            return (
              <div
                key={course.id}
                className={`group p-10 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 relative overflow-hidden flex flex-col justify-between min-h-[420px] transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/10 ${!isActive ? 'opacity-60 grayscale cursor-not-allowed' : ''}`}
              >
                <div>
